            ...
            <div className='grid grid-cols-1 gap-5 md:grid-cols-4 mt-10'>
                {
                    Loadings
                        ...
                        : items.topProducts?.slice(0, 4).map((item, index) => (
                            <motion.div
                                key={item._id}
            ...
            >
                <Link to="/all-items">
                    <motion.button
                        ...
                        className='bg-transparent font-semibold text-black md:px-20 px-30 py-3 border border-zinc-400 rounded-full mb-15  cursor-pointer hover:bg-gradient-to-b to-zinc-700 from-zinc-900 hover:text-white'
                    >
                        View All
                    </motion.button>
                </Link>
